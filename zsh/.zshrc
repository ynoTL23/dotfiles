...
# Set to determine number of commands that are stored in the history file
SAVEHIST=10000

# Set to determine number of commands that are loaded into memory from history file
HISTSIZE=5000
...
# PATH exports
# [IMPORTANT MUST]: Keep $PATH at the end
